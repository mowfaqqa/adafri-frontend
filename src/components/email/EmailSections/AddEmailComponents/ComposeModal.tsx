...
import { useComposeEmail } from "@/lib/hooks/email/useComposeEmail";
...
export const ComposeModal = ({ 
  ...
  const {
    ...
    toggleBcc,
    resetForm
  } = useComposeEmail(isOpen, draftEmail);
  ...
  const handleSendEmail = () => {
    handleSend(editMode, onClose);
  };

  // Handle send later
  const handleSendLaterEmail = () => {
    handleSendLater(onClose);
  };
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <ComposeModalActions
            ...
            onSendLater={handleSendLaterEmail}
            error={error}
          />
        </div>
      </DialogContent>
