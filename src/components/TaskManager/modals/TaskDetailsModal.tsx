...
interface TaskDetailsModalProps {
  ...
  onTaskUpdate?: () => void; // Add optional callback for task updates
}
...
const TaskDetailsModal: React.FC<TaskDetailsModalProps> = ({
  ...
  isOpen,
  onOpenChange,
  onTaskUpdate, // Add the callback prop
}) => {
  ...
  return (
    <>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white border-0 rounded-xl px-4 py-2 font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
                        >
      ...
      <CoverModal
        ...
        taskFiles={taskFiles}
        currentCover={task.cover} // Use the actual task cover
      />
    </>
  );
};
