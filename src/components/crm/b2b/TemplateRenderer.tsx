            ...
            <div className="space-y-2 min-w-[250px]">
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-3 rounded-xl">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-bold">{formatCurrency(document.total)}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <tbody>
            {document.items.map((item) => (
              <tr key={item.id}>
                ...
                <td className="border-2 border-gray-400 p-3 text-right">{formatCurrency(item.unitPrice)}</td>
                <td className="border-2 border-gray-400 p-3 text-right font-bold">{formatCurrency(item.total)}</td>
              </tr>
            ))}
          </tbody>
        </table>
        ...
        <div className="flex justify-end mb-4">
          <div className="text-right space-y-2">
            ...
            <div className="border-4 border-gray-800 bg-gray-800 text-white p-3 text-center">
              <div className="text-lg font-bold">TOTAL: {formatCurrency(document.total)}</div>
            </div>
          </div>
        </div>
...
// Former code for TemplateRenderer component
// "use client";
// import React from 'react';
// import { Building, User } from 'lucide-react';
// import type { DocumentData, InvoiceTemplate } from '@/lib/types/invoice/types';
