...
const WorkspaceSidebar: React.FC = () => {
  ...
  return (
    <div className="h-full w-16 bg-gray-800 flex flex-col items-center py-4">
      ...
      <div className="mb-6">
        <Avatar
          ...
          className="cursor-pointer border-2 border-gray-800 hover:border-emerald-500 transition-colors"
        />
      </div>
