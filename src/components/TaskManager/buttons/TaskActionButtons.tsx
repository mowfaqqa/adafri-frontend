...
interface TaskActionButtonsProps {
  ...
  onView?: () => void; // Made optional since card click handles this
  onEdit: () => void;
  variant?: "card" | "modal";
}
      ...
      <>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-36">
            {/* Commented out View since card click handles opening modal */}
            {/* {onView && (
            ...
            {/* Commented out Edit for now as per requirements */}
