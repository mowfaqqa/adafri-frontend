...
export function CommandSuggestions({ 
  ...
  const removeSlashCharacter = () => {
    // For TinyMCE, this is handled in the parent component
    // since slash removal depends on the command trigger type
  };
...
//   // Updated function to work with textarea instead of TinyMCE
//   const removeSlashCharacter = () => {
...
//       // Remove the last '/' character before cursor
//       if (start > 0 && content[start - 1] === '/') {
//         const newContent = content.substring(0, start - 1) + content.substring(start);
//         textarea.value = newContent;
//         textarea.setSelectionRange(start - 1, start - 1);
        
//         // Trigger change event to update parent component
...
// Working code for tinymce editor command suggestions
// import React, { useState, useEffect, useRef } from 'react';
// import EmojiPicker, { EmojiClickData } from 'emoji-picker-react';
// import { Upload, X } from 'lucide-react';
